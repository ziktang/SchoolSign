...
public final class NetUtils {
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        return ((ConnectivityManager) com.schoolsign.utils.Utils.getContext().getSystemService(Context.CONNECTIVITY_SERVICE)).getActiveNetworkInfo();
    }
    ...
    public static boolean isAvailableByPing() {
        ...
        if (result.errorMsg != null) {
            Log.d("isAvailable", result.errorMsg);
        }
        if (result.successMsg != null) {
            Log.d("isAvailable", result.successMsg);
        }
        return ret;
    }
