...
public class StuCourseAdapter extends RecyclerArrayAdapter<Course> {
    ...
    class CourseViewHolder extends BaseViewHolder<Course> {
        ...
        public void setData(Course course) {
            Log.i("AAA","name:"+course.getCname());
            Log.i("AAA","num:"+course.getCid());
            Log.i("AAA","num:"+course.getTname());
            mName.setText(course.getCname());
            mNum.setText("课程编号:"+course.getCid());
            mTeaName.setText("上课老师:"+course.getTname()+"");
        }
    }
}
